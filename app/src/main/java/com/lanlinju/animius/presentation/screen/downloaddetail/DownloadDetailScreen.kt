package com.laqoome.laqoo.presentation.screen.downloaddetail
...
import com.laqoome.laqoo.util.toast
import com.laqoome.download.Progress
import com.laqoome.download.core.DownloadTask
import com.laqoome.download.download
import com.laqoome.download.utils.formatSize
...
import java.io.File
import com.laqoome.download.State as DownloadSate
...
fun DownloadEpisodeItem(
    ...
    Surface(modifier = modifier.fillMaxWidth()) {
        Row(
            ...
            laqooImage(imgUrl = imgUrl, isDownloaded = state.isSucceed.value)
...
@Composable
private fun laqooTitle(title: String) {
    Text(
        text = title,
...
@Composable
private fun laqooImage(imgUrl: String, isDownloaded: Boolean) {
    AsyncImage(
