...
import com.laqoome.laqoo.presentation.theme.SECONDARY_ALPHA
import com.laqoome.laqoo.presentation.theme.padding
import com.laqoome.laqoo.util.shareCrashLog
...
class CrashLogUtil(
    ...
    suspend fun dumpLogs(exception: Throwable? = null) = withContext(NonCancellable) {
        try {
            val file = context.createFileInCacheDir("laqoo_crash_logs.txt")
