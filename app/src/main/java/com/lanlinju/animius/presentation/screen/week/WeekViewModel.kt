...
import com.laqoome.laqoo.work.UpdateWorker
...
class WeekViewModel @Inject constructor(
    ...
    private val _weekDataMap: MutableStateFlow<Resource<Map<Int, List<laqoo>>>> =
        MutableStateFlow(value = Resource.Loading)
    val weekDataMap: StateFlow<Resource<Map<Int, List<laqoo>>>> get() = _weekDataMap
