package com.laqoome.laqoo.parse.gogolaqoo
...
class GogolaqooTest {
    val relativePath = "./src/test/java/com/sakura/laqoo/parse/gogolaqoo/html/" // 保存路径
    ...
    fun getVideoData() = runBlocking {
        ...
        val episodes = getlaqooEpisodes(Jsoup.parse(File(detailHtml)))
    ...
    fun getlaqooDetail() = runBlocking {
        ...
        println("title: $title," + " desc: $desc,\n imgUrl: $imgUrl, tags: $tags, episodes: $episodes, relatedlaqoos: $relatedlaqoos")
    }
    ...
    fun testExtractEpisodeId() = runBlocking {
        val input = "https://gogolaqoo.by/dragon-ball-daima-episode-3-english-subbed/"
